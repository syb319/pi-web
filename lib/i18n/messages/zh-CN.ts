...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.removeProjectFromList": "从列表移除",
    "sidebar.removeProjectConfirm": "确定从列表中移除此项目吗？\n\n{path}\n\n不会删除项目目录、文件或聊天记录。",
    "sidebar.removeCurrentProjectTitle": "请先切换到其他项目再移除",
    "sidebar.removeRunningProjectTitle": "此项目中有任务正在运行",
    "sidebar.restoreRemovedProjects": "恢复已移除的项目",
    ...
    "sidebar.openFolder": "在资源管理器中打开项目目录",
    "sidebar.openingFolder": "正在打开项目目录…",
    "sidebar.openFolderFailed": "无法打开项目目录",
    ...
    "chat.uploadFile": "上传文件到项目并添加到此消息",
    "chat.uploadingFile": "正在上传文件",
    "chat.uploadFileRequiresProject": "上传文件前请先选择项目文件夹",
    "chat.dropFiles": "将图片或文件拖放到这里",
