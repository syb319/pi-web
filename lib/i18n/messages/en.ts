...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.removeProjectFromList": "Remove from list",
    "sidebar.removeProjectConfirm": "Remove this project from the list?\n\n{path}\n\nThe folder, files, and chat history will not be deleted.",
    "sidebar.removeCurrentProjectTitle": "Switch to another project before removing this one",
    "sidebar.removeRunningProjectTitle": "A task is running in this project",
    "sidebar.restoreRemovedProjects": "Restore removed projects",
    ...
    "sidebar.openFolder": "Open project folder",
    "sidebar.openingFolder": "Opening project folder…",
    "sidebar.openFolderFailed": "Could not open project folder",
    ...
    "chat.uploadFile": "Upload file to the project and add it to this message",
    "chat.uploadingFile": "Uploading file",
    "chat.uploadFileRequiresProject": "Choose a project folder before uploading a file",
    "chat.dropFiles": "Drop images or files here",
