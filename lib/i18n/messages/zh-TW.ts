...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.removeProjectFromList": "從清單移除",
    "sidebar.removeProjectConfirm": "確定從清單中移除此專案嗎？\n\n{path}\n\n不會刪除專案目錄、檔案或聊天記錄。",
    "sidebar.removeCurrentProjectTitle": "請先切換到其他專案再移除",
    "sidebar.removeRunningProjectTitle": "此專案中有工作正在執行",
    "sidebar.restoreRemovedProjects": "恢復已移除的專案",
    ...
    "sidebar.openFolder": "在檔案總管中開啟專案目錄",
    "sidebar.openingFolder": "正在開啟專案目錄…",
    "sidebar.openFolderFailed": "無法開啟專案目錄",
    ...
    "chat.uploadFile": "上傳檔案到專案並加入此訊息",
    "chat.uploadingFile": "正在上傳檔案",
    "chat.uploadFileRequiresProject": "上傳檔案前請先選擇專案資料夾",
    "chat.dropFiles": "將圖片或檔案拖放到這裡",
